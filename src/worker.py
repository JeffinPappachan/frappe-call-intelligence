...
from src.schemas import ProcessingStatus, TelephonyWebhookPayload, CallDirection, CallStatus
...
async def requeue_stuck_jobs(pipeline):
    ...
    try:
        ...
        res = pipeline.idempotency_store.client.table("calls")\
...
async def run_worker():
    ...
    while not _shutdown_requested:
        try:
            ...
            await pipeline.process_call_background(event=event)
